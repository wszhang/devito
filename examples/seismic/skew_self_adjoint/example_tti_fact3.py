...
p_3 = Function(name='p_3', grid=grid, space_order=space_order)
...
op = Operator([eq_b1m2e, eq_b1mf, eq_b2epfa2, eq_bfes1ma2, eq_bfa2,
              ...
              subs=spacing_map, name='OpExampleTtiFact3')

f = open("operator.tti_fact3.c", "w")
print(op, file=f)
f.close()
